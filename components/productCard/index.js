...
export default function ProductCard({ product }) {
  ...
  const [prices, setPrices] = useState(
    (product.subProducts[active]?.sizes.map((s) => {
      ...
      return a - b // sort from lowest to highest prices.
    }))
  )
  ...
  console.log("Client Styles:", styless)

  // console.log("The prices from lowest to highest:", prices)

  // console.log("Sub Product Images:", images)
  useEffect(() => {
